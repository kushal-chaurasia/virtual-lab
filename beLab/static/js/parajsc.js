...
//    arr[4] = document.getElementById("res2").value;
    ...
    if (document.getElementById("dc").value == "") {
        ...
        document.getElementById("req").value = (((document.getElementById("res1").value) * (document.getElementById("res2").value * 1000)) / ((document.getElementById("res1").value) + (document.getElementById("res2").value * 1000)));
